      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-12 col-lg-6 text-center">
          <div class="inner-banner_content">
            <h1>our Gift<span>Bundles</span></h1>
            <ul>
              <li><a href="{{url('/')}}">home</a></li>
              /
              <li>
                <a href="#" class="active">Our Gift</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-12 col-lg-3 p-3">
          <div class="caterogy-card">
            ...
            <ul>
                @php
                $category=App\Entity\Category\Category::where('is_gift',1)->get();
                @endphp
          ...
          <div class="filter-card">
            <div class="row">
              ...
              <div class='row products_from_filter'>
                @php
                $products=App\Entity\Product\Product::where('is_gift',1)->get();
                @endphp
