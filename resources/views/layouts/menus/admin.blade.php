...
<li>
	<a href="javascript: void(0);"><i class="ti-package"></i><span>{{ _lang('Gift Bundles') }}</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
	<ul class="nav-second-level" aria-expanded="false">
		<li class="nav-item"><a class="nav-link" href="{{ url('admin/gift/index') }}">{{ _lang('Bundle List') }}</a></li>	
		<li class="nav-item"><a class="nav-link" href="{{url('admin/gift/create')}}">{{ _lang('Create Bundle') }}</a></li>
	</ul>
</li>

<li>
	<a href="javascript: void(0);"><i class="ti-package"></i><span>{{ _lang('Gift Category') }}</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
	<ul class="nav-second-level" aria-expanded="false">
		<li class="nav-item"><a class="nav-link" href="{{ url('admin/bundle/category/index') }}">{{ _lang('Gift Category List') }}</a></li>	
		<li class="nav-item"><a class="nav-link" href="{{url('admin/bundle/category/create')}}">{{ _lang('Create Gift Category') }}</a></li>
	</ul>
</li>
