    ...
    <div class="row">
        <div class="col-sm-3">
			<ul class="nav flex-column nav-tabs settings-tab" role="tablist">
				...
				<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#uploadcsv"><i class="ti-server"></i> {{ _lang('Upload Csv') }}</a></li>
		...
		<div class="col-sm-9">
			<div class="tab-content">
				...
				<div id="uploadcsv" class="tab-pane fade">
					<div class="card">
						<div class="card-header">
							<span class="panel-title">{{ _lang('Csv Settings') }}</span>
						</div>
						<div class="card-body">
							 <form method="post" class="params-panel"   enctype="multipart/form-data" action="{{route('uploadCsv')}}">
                                  @csrf
								<div class="row">
									<div class="col-md-12">
									  <div class="form-group">
										<label class="control-label">{{ _lang('Upload Product CSV') }}</label>				
							 ...
							 <form method="post" class="params-panel"   enctype="multipart/form-data" action="{{route('uploadCategoryCsv')}}">
                                  @csrf
								<div class="row">
									<div class="col-md-12">
									  <div class="form-group">
										<label class="control-label">{{ _lang('Upload Category CSV') }}</label>				
										<input  class='form-control' type="file" name="csv_file" >
									  </div>
									</div>
									<div class="col-md-12">
							 ...
							 <form method="post" class="params-panel"   enctype="multipart/form-data" action="{{route('categoryTranslationCsv')}}">
                                  @csrf
								<div class="row">
									<div class="col-md-12">
									  <div class="form-group">
										<label class="control-label">{{ _lang('Upload  Brand CSV') }}</label>				
										<input  class='form-control' type="file" name="csv_file" >
									  </div>
									</div>
									<div class="col-md-12">
