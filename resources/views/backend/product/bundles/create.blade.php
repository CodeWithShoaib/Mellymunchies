                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="is_gift" value="1">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label">{{ _lang('Products') }}</label>
                                            <select class="form-control auto-multiple-select select2"
                                                data-selected="[{{ old('products') ? implode(', ', old('products')) : '' }}]"
                                                name="products_id[]" multiple>
                                                {{ buildOptionTree(\App\Entity\Product\Product::all(), 0, null, 0, -1) }}
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label">{{ _lang('Description') }} <span class="required">
                                                    *</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control auto-select select2"
                                                data-selected="{{ old('brand_id') }}" name="brand_id">
                                                <option value="">{{ _lang('Select One') }}</option>
                                                @foreach (\App\Entity\Brand\Brand::all() as $brand)
                                                    <option value="{{ $brand->id }}">{{ $brand->translation->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control auto-select select2"
                                                data-selected="{{ old('tax_class_id') }}" name="tax_class_id">
                                                <option value="">{{ _lang('Select One') }}</option>
                                                @foreach (\App\Entity\Tax\Tax::all() as $tax)
                                                    <option value="{{ $tax->id }}">{{ $tax->translation->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control auto-multiple-select select2"
                                                data-selected="[{{ old('categories') ? implode(', ', old('categories')) : '' }}]"
                                                name="categories[]" multiple>
                                                <option value="">{{ _lang('Select Category') }}</option>
                                                @php
                                                    $cats = App\Entity\Category\Category::where('is_gift', 1)->get();
                                                @endphp
                                                @foreach ($cats as $item)
                                                    @php
                                                        $category_translation = App\Entity\Category\CategoryTranslation::where('category_id', $item->id)->first();
                                                    @endphp
                                                    <option value="{{ $item->id }}">{{ $category_translation->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control auto-multiple-select select2"
                                                data-selected="[{{ old('tags') ? implode(', ', old('tags')) : '' }}]"
                                                name="tags[]" multiple>
                                                @foreach (\App\Entity\Tag\Tag::all() as $tag)
                                                    <option value="{{ $tag->id }}">{{ $tag->translation->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label
                                                class="control-label">{{ _lang('Special Price') . ' (' . currency() . ')' }}</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control auto-select"
                                                data-selected="{{ old('is_active', 1) }}" name="is_active" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control auto-select"
                                                data-selected="{{ old('featured_tag') }}" name="featured_tag">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label">{{ _lang('Bundle Type') }}</label>
                                            <select class="form-control auto-select" id="product_type"
                                                data-selected="{{ old('product_type', 'simple_product') }}"
                                    ...
                                    <div class="col-md-12 d-none" id="digital_file">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control dropify" name="digital_file"
                                                data-allowed-file-extensions="zip"
                                                data-max-file-size="{{ get_option('digital_file_max_upload_size', 2) }}M">
                                        </div>
                                    </div>


                                    <div
                                        class="col-md-12 variable-product {{ old('product_type') == 'variable_product' ? '' : 'd-none' }}">
                                            ...
                                            @foreach (old('product_option') as $product_option)
                                                <div class="row product-option" {{ $loop->first ? 'id="option"' : '' }}>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">{{ _lang('Option Name') }}</label>
                                                            <input type="text" class="form-control product_option"
                                                                name="product_option[]" value="{{ $product_option }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">{{ _lang('Option Value') }}</label>
                                                            <input type="text"
                                                                class="form-control product_option_value"
                                                                name="product_option_value[]"
                                                                value="{{ old('product_option_value.' . $loop->index) }}"
                                            ...
                                            <div class="row product-option" id="option">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control product_option_value"
                                                            name="product_option_value[]"
                                                            placeholder="Ex - Red, Green, Blue">
                                                    </div>
                                                </div>
                                    ...
                                    <div
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <input type="text" name="variation_price[]"
                                                                                class="form-control"
                                                                                value="{{ old('variation_price.' . $loop->index) }}"
                                                                                placeholder="{{ _lang('Regular Price') }}">
                                                                        </td>
                                                                        <td>
                                                                            <input type="text"
                                                                                name="variation_special_price[]"
                                                                                class="form-control"
                                                                                value="{{ old('variation_special_price.' . $loop->index) }}"
                                                                                placeholder="{{ _lang('Special Price') }}">
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <input type="checkbox" name="is_available[]"
                                                                                value="{{ old('is_available.' . $loop->index) }}">
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
                                                            @endif
                                                ...
                                                <button type="button" class="btn btn-light btn-xs btn-block"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button type="submit"
                                                class="btn btn-primary">{{ _lang('Save Product') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control auto-select"
                                                        data-selected="{{ old('manage_stock', 0) }}" name="manage_stock"
                                                        id="manage_inventory" required>
                                            ...
                                            <div class="col-md-12 inventory-quantity d-none">
                                                <div class="form-group">
                                                    <label class="control-label">{{ _lang('Qty') }} <span
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control auto-select"
                                                        data-selected="{{ old('in_stock', 1) }}" name="in_stock">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="meta[meta_keywords]"
                                                        value="{{ old('meta[meta_keywords]') }}">
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <button type="button" class="choose-media btn btn-light"
                                                data-media-type="image" data-input-name="files[product_image]">
                                                <i class="fa fa-folder-open m-r-5"></i> {{ _lang('Gift Bundle Image') }}
                                            </button>
                                        ...
                                        <div class="form-group">
                                            <button type="button" class="choose-media btn btn-light"
                                                data-multiple="true" data-media-type="image"
                                                data-input-name="files[gallery_images][]">
                                                <i class="fa fa-folder-open m-r-5"></i> {{ _lang('Gift Bundle Images') }}
                                            </button>
